 ...
 *  @作者 ：贺兴波
 *  @时间 ：2018/8/11
 *  @描述 ：CrashHandler UncaughtException处理类,当程序发生Uncaught异常的时候,由该类来接管程序,并记录发送错误报告.
 */
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // 控制是否生成日志文件，当程序遇到非主动退出时（异常）生成日志文件，当程序主动退出时不生成日志文件
